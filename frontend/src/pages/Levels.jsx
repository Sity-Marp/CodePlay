    ...
    return (
        <div className="levels">
            <div className="levels-planet">
                ...
                <div className={`planetlvl css-planet ${!isCssUnlocked ? 'locked' : ''}`}>
                ...
                <div className={`planetlvl javascript-planet ${!isJavaScriptUnlocked ? 'locked' : ''}`}>
                ...
                <div className={`planetlvl earth-planet ${!isEarthUnlocked ? 'locked' : ''}`}>
